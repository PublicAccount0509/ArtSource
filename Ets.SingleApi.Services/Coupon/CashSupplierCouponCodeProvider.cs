...
{
    /// <summary>
    /// 类名称：CashSupplierCouponCodeProvider
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class CashSupplierCouponCodeProvider : ISupplierCouponCodeProvider
    {
        /// <summary>
        ...
        {
            get { return CouponCodeType.Cash; }
        }
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public CashSupplierCouponCodeProvider(INHibernateRepository<CouponEntity> couponEntityRepository)
        {

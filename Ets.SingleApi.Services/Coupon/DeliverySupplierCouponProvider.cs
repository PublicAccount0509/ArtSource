namespace Ets.SingleApi.Services
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class DeliverySupplierCouponProvider : ISupplierCouponProvider
    {
        /// <summary>
        ...
        public DeliveryMethodType DeliveryMethodType
        {
            get
            {
                return DeliveryMethodType.Delivery;
            }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DeliverySupplierCouponProvider" /> class.
        /// </summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public DeliverySupplierCouponProvider(
                        ...
                        select new
                            {
                                ...
                                TypeId = couponEntity.SupplierCouponTypeId,
                                Min = couponEntity.RateLower,
                                Max = couponEntity.RateHigh,

namespace Ets.SingleApi.Services.ICacheServices
{
    ...
    /// <summary>
    /// 接口名称：IHuangTaiJiShoppingCartCacheServices
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public interface IHuangTaiJiShoppingCartCacheServices
    {
        /// <summary>
        /// 取得餐厅信息
        /// </summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        CacheServicesResult<HuangTaiJiShoppingCartOrder> GetShoppingCartOrder(string source, string id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        CacheServicesResult<bool> SaveShoppingCartOrder(string source, HuangTaiJiShoppingCartOrder order);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        CacheServicesResult<HuangTaiJiShoppingCart> GetShoppingCart(string source, string id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        CacheServicesResult<bool> SaveShoppingCart(string source, HuangTaiJiShoppingCart shoppingCart);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        CacheServicesResult<HuangTaiJiShoppingCartLink> GetShoppingCartLink(string source, string shoppingCartLinkId);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        CacheServicesResult<bool> SaveShoppingCartLink(string source, HuangTaiJiShoppingCartLink shoppingCartLink);
    }
}
namespace Ets.SingleApi.Services
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class EtsWapShoppingCartProvider : IEtsWapShoppingCartProvider
    {
        /// <summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        private readonly IEtsWapShoppingCartCacheServices etsWapShoppingCartCacheServices;
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public EtsWapShoppingCartProvider(
            ...
            IEtsWapShoppingCartCacheServices etsWapShoppingCartCacheServices)
        {

namespace Ets.SingleApi.Services
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public interface IEtsWapDingTaiShoppingCartProvider
    {
        /// <summary>
        /// 获取餐厅信息
        /// </summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapDingTaiShoppingCart> GetShoppingCart(string source, string id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapDingTaiShoppingCartOrder> GetShoppingCartOrder(string source, string id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapDingTaiShoppingCartLink> GetShoppingCartLink(string source, string shoppingCartLinkId);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapDingTaiShoppingCartLink> GetShoppingCartLink(string source, int supplierId, string anonymityId);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<bool> SaveShoppingCart(string source, EtsWapDingTaiShoppingCart shoppingCart);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<bool> SaveShoppingCartOrder(string source, EtsWapDingTaiShoppingCartOrder shoppingCartOrder);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<bool> SaveShoppingCartLink(string source, EtsWapDingTaiShoppingCartLink shoppingCartLink);

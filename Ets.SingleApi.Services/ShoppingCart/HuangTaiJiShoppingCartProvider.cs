namespace Ets.SingleApi.Services
{
    ...
    /// <summary>
    /// 类名称：HuangTaiJiShoppingCartProvider
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class HuangTaiJiShoppingCartProvider : IHuangTaiJiShoppingCartProvider
    {
        /// <summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        private readonly IHuangTaiJiShoppingCartCacheServices huangTaiJiShoppingCartCacheServices;
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public HuangTaiJiShoppingCartProvider(
            ...
            IHuangTaiJiShoppingCartCacheServices huangTaiJiShoppingCartCacheServices)
        {
            ...
            this.huangTaiJiShoppingCartCacheServices = huangTaiJiShoppingCartCacheServices;
        }
        ...
        {
            var shoppingCartCacheResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartSupplier(source, supplierId);
            ...
            if (timeTableDisplayIdList.Count == 0)
            {
                ...
                this.huangTaiJiShoppingCartCacheServices.SaveShoppingCartSupplier(source, shoppingCartSupplier);
                return new ServicesResult<ShoppingCartSupplier>
                {
        ...
        public ServicesResult<ShoppingCartCustomer> GetShoppingCartCustomer(string source, int? userId)
        {
            ...
            var shoppingCartCacheResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartCustomer(source, userId.Value);
            ...
            this.huangTaiJiShoppingCartCacheServices.SaveShoppingCartCustomer(source, customer);
            return new ServicesResult<ShoppingCartCustomer>
            {
                Result = customer
            };
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<HuangTaiJiShoppingCart> GetShoppingCart(string source, string id)
        {
            var shoppingCartCacheResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCart(source, id);
            if (shoppingCartCacheResult != null && shoppingCartCacheResult.StatusCode == (int)StatusCode.Succeed.Ok)
            {
                return new ServicesResult<HuangTaiJiShoppingCart>
                {
                    Result = shoppingCartCacheResult.Result
                };
            }

            var shoppingCart = new HuangTaiJiShoppingCart
            {
                ShoppingCartId = id,
                IsActive = true
            };

            this.huangTaiJiShoppingCartCacheServices.SaveShoppingCart(source, shoppingCart);
            return new ServicesResult<HuangTaiJiShoppingCart>
            {
                Result = shoppingCart
            };
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<HuangTaiJiShoppingCartOrder> GetShoppingCartOrder(string source, string id)
        {
            var getShoppingCartOrderResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartOrder(source, id);
            return new ServicesResult<HuangTaiJiShoppingCartOrder>
            {
                StatusCode = getShoppingCartOrderResult.StatusCode,
                Result = getShoppingCartOrderResult.Result ?? new HuangTaiJiShoppingCartOrder()
            };
        }
        ...
        {
            var shoppingCartDeliveryResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartDelivery(source, id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<bool> SaveShoppingCart(string source, HuangTaiJiShoppingCart shoppingCart)
        {
            var saveShoppingCartResult = this.huangTaiJiShoppingCartCacheServices.SaveShoppingCart(source, shoppingCart);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<bool> SaveShoppingCartOrder(string source, HuangTaiJiShoppingCartOrder shoppingCartOrder)
        {
            var saveShoppingCartOrderResult = this.huangTaiJiShoppingCartCacheServices.SaveShoppingCartOrder(source, shoppingCartOrder);
            return new ServicesResult<bool>
            {
        ...
        {
            var saveShoppingCartDeliveryResult = this.huangTaiJiShoppingCartCacheServices.SaveShoppingCartDelivery(source, shoppingCartDelivery);
            return new ServicesResult<bool>
            {
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<HuangTaiJiShoppingCartLink> GetShoppingCartLink(string source, string shoppingCartLinkId)
        {
            var getShoppingCartLinkResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartLink(source, shoppingCartLinkId);
            return new ServicesResult<HuangTaiJiShoppingCartLink>
            {
                StatusCode = getShoppingCartLinkResult.StatusCode,
                Result = getShoppingCartLinkResult.Result ?? new HuangTaiJiShoppingCartLink()
            };
        }
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<HuangTaiJiShoppingCartLink> GetShoppingCartLink(string source, int supplierId, string anonymityId)
        {
            var getShoppingCartLinkResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartLink(source, string.Format("{0}_{1}", anonymityId, supplierId));
            var shoppingCartLink = getShoppingCartLinkResult.Result ?? new HuangTaiJiShoppingCartLink();
            var getShoppingCartOrderResult = this.huangTaiJiShoppingCartCacheServices.GetShoppingCartOrder(source, shoppingCartLink.OrderId);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<bool> SaveShoppingCartLink(string source, HuangTaiJiShoppingCartLink shoppingCartLink)
        {
            var saveShoppingCartLinkResult = this.huangTaiJiShoppingCartCacheServices.SaveShoppingCartLink(source, shoppingCartLink);
            return new ServicesResult<bool>
            {

namespace Ets.SingleApi.Services
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public interface IEtsWapPaiDuiShoppingCartProvider
    {
        /// <summary>
        /// 获取餐厅信息
        /// </summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapPaiDuiShoppingCart> GetShoppingCart(string source, string id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapPaiDuiShoppingCartOrder> GetShoppingCartOrder(string source, string id);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapPaiDuiShoppingCartLink> GetShoppingCartLink(string source, string shoppingCartLinkId);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<EtsWapPaiDuiShoppingCartLink> GetShoppingCartLink(string source, int supplierId, string anonymityId);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<bool> SaveShoppingCart(string source, EtsWapPaiDuiShoppingCart shoppingCart);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<bool> SaveShoppingCartOrder(string source, EtsWapPaiDuiShoppingCartOrder shoppingCartOrder);
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        ServicesResult<bool> SaveShoppingCartLink(string source, EtsWapPaiDuiShoppingCartLink shoppingCartLink);

namespace Ets.SingleApi.Services
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class TelephoneAccount : IAccount
    {
        /// <summary>
        ...
        public AccountType AccountType
        {
            get
            {
                return AccountType.Telephone;
            }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="TelephoneAccount" /> class.
        /// </summary>

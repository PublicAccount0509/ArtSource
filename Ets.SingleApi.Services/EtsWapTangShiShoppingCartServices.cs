...
namespace Ets.SingleApi.Services
{
    ...
    /// <summary>
    /// 类名称：EtsWapTangShiShoppingCartServices
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class EtsWapTangShiShoppingCartServices : IEtsWapTangShiShoppingCartServices
    {
        /// <summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public EtsWapTangShiShoppingCartServices(
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<EtsWapTangShiShoppingCartModel> GetShoppingCart(string source, string shoppingCartId)
        {
            ...
            {
                return new ServicesResult<EtsWapTangShiShoppingCartModel>
                {
        ...
        public ServicesResult<string> CreateShoppingCart(string source, int supplierId, string userId)
        {
            ...
            var shoppingCartLink = new EtsWapTangShiShoppingCartLink
                {
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<bool> SaveShoppingCart(string source, string id, EtsWapTangShiShoppingCartModel shoppingCart)
        {
            var getShoppingCartLinkResult = this.etsWapShoppingCartProvider.GetShoppingCartLink(source, id);
            if (getShoppingCartLinkResult.StatusCode != (int)StatusCode.Succeed.Ok)
            {
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public ServicesResult<bool> SaveShoppingCartOrder(string source, string id, EtsWapTangShiShoppingCartOrder shoppingCartOrder, bool isCalculateCoupon)
        {
            var getShoppingCartLinkResult = this.etsWapShoppingCartProvider.GetShoppingCartLink(source, id);
            if (getShoppingCartLinkResult.StatusCode != (int)StatusCode.Succeed.Ok)
            {
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        private void SaveShoppingCartOrder(string source, List<ShoppingCartItem> shoppingList, ShoppingCartSupplier supplier, EtsWapTangShiShoppingCartOrder order)
        {
            var shoppingPrice = shoppingList.Sum(p => p.Quantity * p.Price);
            var totalfee = shoppingPrice;
            var total = totalfee;

namespace Ets.SingleApi.Services
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class TangShiOrderNumber : IOrderNumber
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TangShiOrderNumber"/> class.
        /// </summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public TangShiOrderNumber(INHibernateRepository<OrderNumberDtEntity> orderNumberDtEntityRepository)
        {

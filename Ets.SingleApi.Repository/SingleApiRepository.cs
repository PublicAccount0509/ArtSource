namespace Ets.SingleApi.Repository
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class SingleApiRepository<TEntity> : NHibernateRepository<TEntity> where TEntity : class ,new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleApiRepository{TEntity}"/> class.
        /// </summary>
        ...
        /// 修改时间：
        /// ----------------------------------------------------------------------------------------
        public SingleApiRepository(ISessionManager sessionManager)
            : base(sessionManager, "SingleApiFactory")
        {
        }

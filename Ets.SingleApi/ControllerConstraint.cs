namespace Ets.SingleApi
{
    ...
    /// 修改时间：
    /// ----------------------------------------------------------------------------------------
    public class ControllerConstraint : IHttpRouteConstraint
    {
        /// <summary>
        /// 确定此实例是否等于指定的路由。
        /// </summary>
        ...
        public bool Match(HttpRequestMessage request, IHttpRoute route, string parameterName, IDictionary<string, object> values, HttpRouteDirection routeDirection)
        {
            ...
            if (!string.Equals(parameterName, "controller", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }
            ...
            return !shoppingCartList.Any(p => string.Equals(p, parameterValue, StringComparison.OrdinalIgnoreCase));
        }
    }
}
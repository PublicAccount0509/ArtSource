namespace Ets.SingleApi.Hosting.Contracts
{
    ...
    /// <summary>
    /// 接口名称：IEtsWapTangShiShoppingCartService
    ...
    /// ----------------------------------------------------------------------------------------
    [ServiceContract]
    public interface IEtsWapTangShiShoppingCartService
    {
        /// <summary>
        /// 创建一个购物车
        /// </summary>
        ...
        Response<EtsWapTangShiShoppingCartModel> ShoppingCart(string id);
        ...
        Response<EtsWapTangShiShoppingCartModel> SaveShoppingCart(string id, EtsWapTangShiShoppingCartRequst requst);
        ...
        Response<EtsWapTangShiShoppingCartModel> Create(int supplierId, string userId, int orderId);
        ...
        Response<EtsWapTangShiShoppingCartModel> Customer(string id, int userId);
        ...
        Response<EtsWapTangShiShoppingCartModel> Delivery(string id, EtsWapTangShiShoppingCartDeliveryRequst requst);
        ...
        Response<EtsWapTangShiShoppingCartModel> Shopping(string id, EtsWapTangShiShoppingCartShoppingRequst requst, bool saveDeliveryMethodId);
        ...
        Response<EtsWapTangShiShoppingCartModel> AddShopping(string id, EtsWapTangShiShoppingCartShoppingRequst requst, bool saveDeliveryMethodId);
        ...
        Response<EtsWapTangShiShoppingCartModel> DeleteShopping(string id, EtsWapTangShiShoppingCartShoppingRequst requst, bool saveDeliveryMethodId);
        ...
        Response<EtsWapTangShiShoppingCartModel> Order(string id, EtsWapTangShiShoppingCartOrderRequst requst, bool isCalculateCoupon, bool isValidateDeliveryTime);
    }
}
namespace Ets.SingleApi.Hosting.Contracts
{
    ...
    public interface IOrdersService
    {
        ...
        /// ----------------------------------------------------------------------------------------
        [OperationContract]
        [Description("方法功能：取得海底捞外卖订单详情；参数说明：id（订单号），orderType（订单类型：0 外卖，1 堂食，2 订台），orderSourceType（订单来源：0 默认类型，1 海底捞；默认为 0）")]
        Response<HaiDiLaoWaiMaiOrderDetailModel> GetHaiDiLaoOrder(string id, int orderType);

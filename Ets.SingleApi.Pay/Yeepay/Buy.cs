...
namespace Ets.SingleApi.Pay.Yeepay
{
    /// <summary>
    ...
    public abstract class Buy
    {
        ...
        // 交易的请求地址
        private static string nodeAuthorizationURL = ConfigurationManager.AppSettings["YeepayAuthorizationURL"];

        // 交易的请求地址
        private static string queryRefundReqURL = ConfigurationManager.AppSettings["YeepayQueryRefundReqURL"];

        // 商户编号
        private static string merchantId = ConfigurationManager.AppSettings["YeepayMerhantId"];

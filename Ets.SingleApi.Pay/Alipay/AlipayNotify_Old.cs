...
namespace Ets.SingleApi.Pay.Alipay
{
    ...
    public class Notify_Old
    {
        ...
        //HTTPS支付宝通知路径
        private string Https_veryfy_url = "https://mapi.alipay.com/cooperate/gateway.do?service=notify_verify&";
        //HTTP支付宝通知路径
        ...
        public Notify_Old()
        {
            ...
            _transport = Config_Old.Transport.Trim().ToLower();
        }
        ...
        private string GetResponseMysign(SortedDictionary<string, string> inputPara)
        {
            ...
            //获得签名结果
            string  mysign = Core_Old.BuildMysign(sPara, _key, _sign_type, _input_charset);

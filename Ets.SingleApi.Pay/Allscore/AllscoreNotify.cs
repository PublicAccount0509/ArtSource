...
namespace Ets.SingleApi.Pay.Allscore
{
    ...
    {
        #region 字段
        private string _transport = "https";             //访问模式
        private string _merchantId = "";            //商户ID
        private string _key = "";                   //交易安全校验码
        private string _input_charset = "";         //编码格式

        //HTTPS奥斯卡通知路径（正式地址）
        private string Https_veryfy_url = "http://pay.allscore.com/noticeQuery.htm?";
        //HTTP奥斯卡通知路径（测试地址）
        private string Http_veryfy_url = "http://pay.allscore.com/noticeQuery.htm?";
        #endregion
        ...
        public Notify()
        {
            ...
            _transport = Config.Transport.Trim();
        }
        ...
        private string GetResponseMysign(SortedDictionary<string, string> inputPara)
        {
            ...
            //获得签名结果
            string mysign = Core.BuildMysign(sPara, _key, _input_charset);
        ...
        private string GetResponseTxt(string notify_id)
        {
            ...
            veryfy_url += "merchantId=" + _merchantId + "&notifyId=" + notify_id;

            //获取远程服务器ATN结果，验证是否是奥斯卡服务器发来的请求
